                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $a->keterangan ?></td>
                                        <td>
                                            <a href="<?= base_url('persyaratan/ubah/' . $a->id) ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"> Ubah</i></a>
                                            <a href="<?= base_url('persyaratan/hapus/' . $a->id) ?> " class='btn btn-danger btn-sm' onclick='return confirm(\"Ingin hapus data ini?/") '>
